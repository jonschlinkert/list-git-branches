# Contributing to list-git-branches

First and foremost, thank you! We appreciate that you want to contribute to list-git-branches, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for list-git-branches**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for list-git-branches:

- star the [project](https://github.com/jonschlinkert/list-git-branches)
- tweet your support for list-git-branches
...
- **version**: please note the version of list-git-branches are you using
...
[so]: http://stackoverflow.com/questions/tagged/list-git-branches